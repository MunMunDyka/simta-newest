...
const settingsItems = [
    { label: 'Profile', icon: User, active: true, path: '/profile/dosen' },
]

export const ProfileDosen = () => {
        ...
        <div className="min-h-screen flex bg-gradient-to-br from-gray-50 via-white to-gray-100">
            ...
            >
                ...
                <nav className="flex-1 p-4 space-y-6 relative z-10">
                    ...
                    <div>
                        <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3 px-3">Jadwal</p>
                        <ul className="space-y-1">
                                    ...
                                    <div className="flex flex-col items-center">
                                        <div className="relative group">
                                            ...
                                            <motion.button
                                                ...
                                                className="absolute bottom-0 right-0 w-10 h-10 bg-blue-500 hover:bg-blue-600 rounded-full flex items-center justify-center text-white shadow-lg disabled:opacity-50"
                                        ...
                                        <h2 className="text-lg font-bold text-gray-800 mt-4 text-center">{nama}</h2>
                                        <div className="flex items-center gap-1 text-sm text-gray-500 mt-1">
                                            <Briefcase className="w-4 h-4" />
                                            <span>NIP: {user?.nim_nip || '-'}</span>
                                        </div>
                                        <p className="text-xs text-gray-400 mt-1">Dosen Pembimbing</p>
                                    </div>
